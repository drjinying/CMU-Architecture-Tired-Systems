    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if ( !orderBlank )
        {
            try
            {
                ...
                res = m.runQueryAndGetResultSet(db_name,ip, SQLStatement);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // If we are connected, then we update the shipped status
            ...
            try
            {
                ...
                rows = Integer.parseInt(m.runQuery(db_name, ip, SQLStatement));
    ...
    private void getPendingOrders() {
        ...
        // inventory database
            ...
            try
            {
                ...
                res = m.runQueryAndGetResultSet(db_name, ip, sqlquery);
